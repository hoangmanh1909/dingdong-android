...
public class IOSDialog extends Dialog {
    ...
    public static class Builder {
        ...
        public IOSDialog.Builder setTitle(int titleId) {
            this.mTitle = mContext.getText(titleId);
            return this;
        }

        public IOSDialog.Builder setTitle(CharSequence title) {
            this.mTitle = title;
            return this;
        }

        public IOSDialog.Builder setMessage(int messageId) {
            this.mMessage = mContext.getText(messageId);
            return this;
        }

        public IOSDialog.Builder setMessage(CharSequence message) {
            this.mMessage = message;
            return this;
        }

        public IOSDialog.Builder setPositiveButton(int textId, OnClickListener listener) {
            this.mPositiveButtonText = mContext.getText(textId);
            this.mPositiveButtonClickListener = listener;
            return this;
        }

        public IOSDialog.Builder setPositiveButton(CharSequence text, OnClickListener listener) {
            this.mPositiveButtonText = text;
            this.mPositiveButtonClickListener = listener;
            return this;
        }

        public IOSDialog.Builder setNegativeButton(int textId, OnClickListener listener) {
            this.mNegativeButtonText = mContext.getText(textId);
            this.mNegativeButtonClickListener = listener;
            return this;
        }

        public IOSDialog.Builder setNegativeButton(CharSequence text, OnClickListener listener) {
            this.mNegativeButtonText = text;
            this.mNegativeButtonClickListener = listener;
            return this;
        }

        public IOSDialog.Builder setCancelable(boolean cancelable) {
            this.mCancelable = cancelable;
            return this;
        }

        public IOSDialog.Builder setContentView(View contentView) {
