...
public class Constants {
    ...
    public static final String KEY_SUPPORT_TYPE = "KEY_SUPPORT_TYPE";
    public static final String TYPE_GOM_HANG = "type_gom_hang";
    public static final String HOTLINE_CALL_SHOW = "tel:0886501080";
    ...
    public static final String HEADER_NUMBER = "tel:";
