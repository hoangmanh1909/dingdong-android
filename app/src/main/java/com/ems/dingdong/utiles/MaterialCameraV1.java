...
public class MaterialCameraV1 {
    ...
    public MaterialCameraV1 countdownSeconds(float lengthLimitSec) {
        return countdownMillis((int) (lengthLimitSec * 1000f));
    }

    public MaterialCameraV1 countdownMinutes(float lengthLimitMin) {
        return countdownMillis((int) (lengthLimitMin * 1000f * 60f));
    }

    public MaterialCameraV1 allowRetry(boolean allowRetry) {
        mAllowRetry = allowRetry;
        return this;
    }

    public MaterialCameraV1 autoSubmit(boolean autoSubmit) {
        mAutoSubmit = autoSubmit;
        return this;
    }

    public MaterialCameraV1 countdownImmediately(boolean immediately) {
        mCountdownImmediately = immediately;
        return this;
    }

    public MaterialCameraV1 saveDir(@Nullable File dir) {
        if (dir == null) return saveDir((String) null);
        return saveDir(dir.getAbsolutePath());
    }

    public MaterialCameraV1 saveDir(@Nullable String dir) {
        mSaveDir = dir;
        return this;
    }

    public MaterialCameraV1 primaryColor(@ColorInt int color) {
        mPrimaryColor = color;
        return this;
    }

    public MaterialCameraV1 primaryColorRes(@ColorRes int colorRes) {
    ...
    public MaterialCameraV1 allowChangeCamera(boolean allowChangeCamera) {
        mAllowChangeCamera = allowChangeCamera;
        return this;
    }

    public MaterialCameraV1 defaultToFrontFacing(boolean frontFacing) {
        mDefaultToFrontFacing = frontFacing;
        return this;
    }

    public MaterialCameraV1 retryExits(boolean exits) {
        mRetryExists = exits;
        return this;
    }

    public MaterialCameraV1 restartTimerOnRetry(boolean restart) {
        mRestartTimerOnRetry = restart;
        return this;
    }

    public MaterialCameraV1 continueTimerInPlayback(boolean continueTimer) {
        mContinueTimerInPlayback = continueTimer;
        return this;
    }

    public MaterialCameraV1 forceCamera1() {
        mForceCamera1 = true;
        return this;
    }

    public MaterialCameraV1 audioDisabled(boolean disabled) {
     ...
     */
    @Deprecated
    public MaterialCameraV1 videoBitRate(@IntRange(from = 1, to = Integer.MAX_VALUE) int rate) {
        return videoEncodingBitRate(rate);
    }

    public MaterialCameraV1 videoEncodingBitRate(@IntRange(from = 1, to = Integer.MAX_VALUE) int rate) {
        mVideoEncodingBitRate = rate;
        return this;
    }

    public MaterialCameraV1 audioEncodingBitRate(@IntRange(from = 1, to = Integer.MAX_VALUE) int rate) {
        mAudioEncodingBitRate = rate;
        return this;
    }

    public MaterialCameraV1 videoFrameRate(@IntRange(from = 1, to = Integer.MAX_VALUE) int rate) {
        mVideoFrameRate = rate;
        return this;
    }

    public MaterialCameraV1 videoPreferredHeight(@IntRange(from = 1, to = Integer.MAX_VALUE) int height) {
        mVideoPreferredHeight = height;
        return this;
    }

    public MaterialCameraV1 videoPreferredAspect(@FloatRange(from = 0.1, to = Float.MAX_VALUE) float ratio) {
        mVideoPreferredAspect = ratio;
        return this;
    }

    public MaterialCameraV1 maxAllowedFileSize(long size) {
        mMaxFileSize = size;
        return this;
    }

    public MaterialCameraV1 qualityProfile(@QualityProfile int profile) {
        mQualityProfile = profile;
        return this;
    }

    public MaterialCameraV1 iconRecord(@DrawableRes int iconRes) {
        mIconRecord = iconRes;
        return this;
    }

    public MaterialCameraV1 iconStop(@DrawableRes int iconRes) {
        mIconStop = iconRes;
        return this;
    }

    public MaterialCameraV1 iconFrontCamera(@DrawableRes int iconRes) {
        mIconFrontCamera = iconRes;
        return this;
    }

    public MaterialCameraV1 iconRearCamera(@DrawableRes int iconRes) {
        mIconRearCamera = iconRes;
        return this;
    }

    public MaterialCameraV1 iconPlay(@DrawableRes int iconRes) {
        mIconPlay = iconRes;
        return this;
    }

    public MaterialCameraV1 iconPause(@DrawableRes int iconRes) {
        mIconPause = iconRes;
        return this;
    }

    public MaterialCameraV1 iconRestart(@DrawableRes int iconRes) {
        mIconRestart = iconRes;
        return this;
    }

    public MaterialCameraV1 labelRetry(@StringRes int stringRes) {
     ...
     */
    public MaterialCameraV1 labelUseVideo(@StringRes int stringRes) {
        mLabelConfirm = stringRes;
        return this;
    }

    public MaterialCameraV1 labelConfirm(@StringRes int stringRes) {
        mLabelConfirm = stringRes;
        return this;
    }
     ...
     */
    public MaterialCameraV1 stillShot() {
        mStillShot = true;
        return this;
    }

    public MaterialCameraV1 autoRecordWithDelayMs(@IntRange(from = -1, to = Long.MAX_VALUE) long delayMillis) {
        mAutoRecord = delayMillis;
        return this;
    }

    public MaterialCameraV1 autoRecordWithDelaySec(@IntRange(from = -1, to = Long.MAX_VALUE) int delaySeconds) {
