...
public class ListBaoPhatAdapter extends RecyclerView.Adapter<ListBaoPhatAdapter.HolderView> implements Filterable {
    private final ListBaoPhatAdapter.FilterDone mFilterDone;

    private List<DeliveryPostman> mListFilter;
    private List<DeliveryPostman> mList;
    private Context mContext;
    private ListBaoPhatAdapter.TypeBD13 mTypeBD13;

    public ListBaoPhatAdapter(Context context, ListBaoPhatAdapter.TypeBD13 typeBD13, List<DeliveryPostman> items, ListBaoPhatAdapter.FilterDone filterDone) {
        mListFilter = items;
        mList = items;
    ...
    @Override
    public ListBaoPhatAdapter.HolderView onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ListBaoPhatAdapter.HolderView(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_list_create_bd13_v1, parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull ListBaoPhatAdapter.HolderView holder, int position) {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    for (DeliveryPostman row : mList) {
                        ...
                        if (mTypeBD13 == ListBaoPhatAdapter.TypeBD13.LIST_BD13) {
...
//        public ImageView imgDoitra;
        ...
        public void bindView(Object model) {
            ...
            if (!TextUtils.isEmpty(item.getMaE())) {
                if (mTypeBD13 == ListBaoPhatAdapter.TypeBD13.LIST_BD13) {
                    tv_code.setText("(" + item.getOrderNumberInBD13() + "). " + item.getMaE());
                } else {
