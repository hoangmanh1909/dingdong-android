        ...
        mInteractor.searchStatisticCollect(postmanID, fromDate, toDate, new CommonCallback<SimpleResult>((Activity) mContainerView) {
            ...
            protected void onSuccess(Call<SimpleResult> call, Response<SimpleResult> response) {
                ...
                if (response.body().getErrorCode().equals("00")) {
                    ArrayList<StatisticCollect> collectArrayList = NetWorkControllerGateWay.getGson().fromJson(response.body().getData(),new TypeToken<List<StatisticCollect>>(){}.getType());
