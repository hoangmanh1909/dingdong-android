        ...
        mInteractor.getDebitStatistic(postmanID, mFromDate, mToDate, routeCode, new CommonCallback<SimpleResult>((Activity) mContainerView) {
            ...
            protected void onSuccess(Call<SimpleResult> call, Response<SimpleResult> response) {
                ...
                if (response.body().getErrorCode().equals("00")) {
                    StatisticDebitGeneralResponse statisticDebitGeneralResponse = NetWorkController.getGson().fromJson(response.body().getData(), new TypeToken<StatisticDebitGeneralResponse>(){}.getType());
