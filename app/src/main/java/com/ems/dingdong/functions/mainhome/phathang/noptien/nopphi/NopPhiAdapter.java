...
public class NopPhiAdapter extends RecyclerView.Adapter<NopPhiAdapter.HolderView> implements Filterable {
    ...
    public NopPhiAdapter(Context context, List<EWalletDataResponse> list, FilterDone filterDone) {
    ...
    public HolderView onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new HolderView(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_payment, parent, false));
    }
