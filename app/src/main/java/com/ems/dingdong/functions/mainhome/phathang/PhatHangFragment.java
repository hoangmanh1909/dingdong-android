        ...
        try {
            ...
            if (!userJson.isEmpty()) {
                ...
                if (!"6".equals(userInfo.getEmpGroupID())) {
                    ...
                    homeInfos.add(new HomeInfo(22, R.drawable.transfer, "Quản lý nhập chuyển hoàn"));
...
//                homeInfos.add(new HomeInfo(18, R.drawable.ic_baseline_contact_phone_24_l1, "Thống kê log cuộc gọi"));
                    ...
                    homeInfos.add(new HomeInfo(20, R.drawable.statistic_tiket_01, "Quản lý ticket"));
                    homeInfos.add(new HomeInfo(17, R.drawable.ic_sml_123, "Smartlocker"));

//                homeInfos.add(new HomeInfo(21, R.drawable.ic_thong_ke_bao_phat, "Báo phát mới"));
//                homeInfos.add(new HomeInfo(19, R.drawable.ic_baseline_contact_phone_24_l1, "Quản lí lịch sử cuộc gọi"));
                ...
                public void onBindViewHolder(@NonNull HolderView holder, int position) {
                    ...
                    holder.itemView.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            } else if (homeInfo.getId() == 22) {
                                mPresenter.showBuuGuiChuyenHoan();
                            }
                        }
                    });
                }
            ...
            Toast.showToast(getViewContext(), "Phat Hang");
        }
