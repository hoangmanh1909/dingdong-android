...
interface ListDeliverySuccessDetailContract {
    ...
    interface Interactor extends IInteractor<Presenter> {
        void statisticDeliveryDetail(String serviceCode, int typeDelivery, String postmanID, String fromDate, String toDate, StatisticType statisticType, String routeCode, CommonCallback<SimpleResult> callback);
    }
