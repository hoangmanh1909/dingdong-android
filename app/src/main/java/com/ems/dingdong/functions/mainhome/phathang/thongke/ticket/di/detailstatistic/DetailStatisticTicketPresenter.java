...
import com.ems.dingdong.functions.mainhome.phathang.thongke.ticket.di.detailstatistic.detailladingcode.DetailLadingCodePresenter;
...
public class DetailStatisticTicketPresenter extends Presenter<DetailStatisticTicketContract.View, DetailStatisticTicketContract.Interactor>
    ...
    @Override
    public void ddTicketDen(List<String> strings) {
        mView.showProgress();
        mInteractor.ddTicketDen(strings)
                .subscribeOn(Schedulers.io())
    ...
    public DetailStatisticTicketPresenter setType(List<String> status) {
        strings = status;
        return this;
    }
