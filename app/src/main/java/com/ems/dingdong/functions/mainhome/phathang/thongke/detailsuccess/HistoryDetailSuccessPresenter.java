        ...
        mInteractor.statisticDeliveryGeneral(postmanID, fromDate, toDate, mStatisticType, routeCode, new CommonCallback<SimpleResult>((Activity) mContainerView) {
            ...
            protected void onSuccess(Call<SimpleResult> call, Response<SimpleResult> response) {
                ...
                if (response.body().getErrorCode().equals("00")) {
                    ArrayList<StatisticDeliveryGeneralResponse> deliveryGeneralResponses = NetWorkController.getGson().fromJson(response.body().getData(),new TypeToken<ArrayList<StatisticDeliveryGeneralResponse>>(){}.getType());
