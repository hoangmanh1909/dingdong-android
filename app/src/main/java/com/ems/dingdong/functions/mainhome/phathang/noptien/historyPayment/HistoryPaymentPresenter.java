...
public class HistoryPaymentPresenter extends Presenter<HistoryPaymentContract.View, HistoryPaymentContract.Interactor>
        implements HistoryPaymentContract.Presenter {
    ...
    private HistoryPaymentContract.OnTabListener tabListener;

    public HistoryPaymentPresenter(ContainerView containerView) {
        super(containerView);
    }
    ...
    @Override
    public HistoryPaymentContract.Interactor onCreateInteractor() {
        return new HistoryPaymentInteractor(this);
    }

    @Override
    public HistoryPaymentContract.View onCreateView() {
        return HistoryPaymentFragment.getInstance();
    }
    ...
    public HistoryPaymentPresenter setTypeTab(int position) {
        mPos = position;
        return this;
    }

    public HistoryPaymentPresenter setOnTabListener(HistoryPaymentContract.OnTabListener listener) {
