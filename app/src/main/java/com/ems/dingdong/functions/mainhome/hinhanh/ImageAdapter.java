...
public class ImageAdapter extends RecyclerView.Adapter<ImageAdapter.HolderView> {
    ...
    @NonNull
    @Override
    public ImageAdapter.HolderView onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ImageAdapter.HolderView(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_image_capture, parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull ImageAdapter.HolderView holder, int position) {
