...
public class ListBaoPhatBD13Adapter extends RecyclerView.Adapter<ListBaoPhatBD13Adapter.HolderView> implements Filterable {
    private final ListBaoPhatBD13Adapter.FilterDone mFilterDone;
    ...
    public ListBaoPhatBD13Adapter(Context context, TypeBD13 typeBD13, List<DeliveryPostman> items, ListBaoPhatBD13Adapter.FilterDone filterDone) {
        mListFilter = items;
        mList = items;
    ...
    public HolderView onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ListBaoPhatBD13Adapter.HolderView(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_list_create_bd13, parent, false));
    }
