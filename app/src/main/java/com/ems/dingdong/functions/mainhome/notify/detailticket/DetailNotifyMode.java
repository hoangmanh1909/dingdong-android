...
public class DetailNotifyMode {
    ...
    @SerializedName("CreatedByGroupName")
    private String createdByGroupName;

    @SerializedName("SenderName")
    private String senderName;
    @SerializedName("TicketResult")
    private String ticketResult;

    @SerializedName("ModifyDate")
    private String modifyDate;

    @SerializedName("ModifyByName")
    ...
    public String getCreatedByGroupName() {
        return createdByGroupName;
    }

    public void setCreatedByGroupName(String createdByGroupName) {
        this.createdByGroupName = createdByGroupName;
    }
}
