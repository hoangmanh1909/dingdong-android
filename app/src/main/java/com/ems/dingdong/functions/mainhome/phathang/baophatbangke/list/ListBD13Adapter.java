...
public class ListBD13Adapter extends RecyclerView.Adapter<ListBD13Adapter.HolderView> implements Filterable {
    private final ListBD13Adapter.FilterDone mFilterDone;
    ...
    public ListBD13Adapter(Context context, TypeBD13 typeBD13, List<DeliveryPostman> items, ListBD13Adapter.FilterDone filterDone) {
        mListFilter = items;
        mList = items;
    ...
    public HolderView onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ListBD13Adapter.HolderView(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_create_bd13, parent, false));
    }
