...
public class TimDuongDiAdapterBaoPhat extends RecyclerView.Adapter<TimDuongDiAdapterBaoPhat.HolderView> implements ItemTouchHelperAdapterBaoPhat {

    List<VpostcodeModel> addressListModelList;
    Context mContext;

    public TimDuongDiAdapterBaoPhat(Context context, List<VpostcodeModel> addressListModelList) {
