...
public class RouteInteractor extends Interactor<RouteConstract.Presenter> implements RouteConstract.Interactor {
    ...
    @Override
    public void searchForApproved(String ladingCode, String fromDate, String toDate, String postmanId, String routeId, String pooCode, CommonCallback<RouteResult> callback) {
        NetWorkController.searchForApproved(ladingCode, fromDate, toDate, postmanId, routeId, pooCode, callback);
    }

    @Override
    public void searchForCancel(String ladingCode, String fromDate, String toDate, String postmanId, String routeId, String pooCode, CommonCallback<RouteResult> callback) {
        NetWorkController.searchForCancel(ladingCode, fromDate, toDate, postmanId, routeId, pooCode, callback);
    }
