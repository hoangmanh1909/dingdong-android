...
import com.vinatti.dingdong.views.picker.blur.PickerUIBlurHelper;
...
public class PickerUI extends RelativeLayout implements PickerUIBlurHelper.BlurFinishedListener {
    ...
    private void createView(AttributeSet attrs) {
        ...
        mChosseTv = (TextView) view.findViewById(R.id.choose_tv);
        mCloseTv = (TextView) view.findViewById(R.id.close_tv);
...
//                        mPickerUIListener.onItemClickPickerUI(which, position, valueResult);
        ...
        mChosseTv.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                mPickerUIListener.onChooseClick(mWhich, mPickerUIListView.getItemInListCenter());
            }
        });
    }
    ...
    public interface PickerUIItemClickListener {
         ...
         */
         ...
         void onChooseClick(int which, int position);
    }
