...
public class Constants {
    ...
    public static final int NHAN_VIEN_THUGOM = 1;
    public static final int NHAN_VIEN_NGHIEP_VU_GOM = 2;
    public static final int CSKH_TINH_NHAN = 3;
    public static final int NHAN_VIEN_NGHIEP_VU_PHAT = 5;
    public static final int CSKH_TINH_PHAT = 6;
    public static final int CSKH_TINH_GUI = 7;


    public static final int CHAT_VOI_BUU_CUC = 10;
    public static final int NHAN_VIEN_THU_GOM_KHAC = 11;
    public static final int BUU_TA_KHAC = 12;
    public static final int CHAM_SOC_KH = 13;
}
